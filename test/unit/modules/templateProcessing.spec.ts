...
describe('templateProcessing', () => {  
  ...
  test('Should compile several books with annotations with a raw default template', () => {
    const defaultTemplate = fs.readFileSync(path.join(process.cwd(), 'test', 'fixtures', 'templateProcessing', 'defaultTemplate.md'), 'utf-8');
  ...
  test('Should compile a custom template and preserve newlines', () => {
    const customTemplate = fs.readFileSync(path.join(process.cwd(), 'test', 'fixtures', 'templateProcessing', 'customTemplateWithPreservedNewlines.md'), 'utf-8');
    const renderedTemplateWithPreservedNewlines = fs.readFileSync(path.join(process.cwd(), 'test', 'fixtures', 'templateProcessing', 'renderedTemplateWithPreservedNewlines.md'), 'utf-8');
...
describe('Custom template with date formatting', () => {
  ...
  test('Should compile several books with annotations with a raw default template with colored background for highlights', () => {
    ...
    const defaultTemplate = fs.readFileSync(path.join(process.cwd(), 'test', 'fixtures', 'templateProcessing', 'customTemplate.md'), 'utf-8');
    const renderedBookOne = fs.readFileSync(path.join(process.cwd(), 'test', 'fixtures', 'templateProcessing', 'renderedAnnotationsOne-custom.md'), 'utf-8');
    const renderedBookTwo = fs.readFileSync(path.join(process.cwd(), 'test', 'fixtures', 'templateProcessing', 'renderedAnnotationsTwo-custom.md'), 'utf-8');
    const renderedBookThree = fs.readFileSync(path.join(process.cwd(), 'test', 'fixtures', 'templateProcessing', 'renderedAnnotationsThree-custom.md'), 'utf-8');
    const renderedBookFour = fs.readFileSync(path.join(process.cwd(), 'test', 'fixtures', 'templateProcessing', 'renderedAnnotationsFour-custom.md'), 'utf-8');
