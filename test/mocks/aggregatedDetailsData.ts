...
export const annotationsToAggregate = [
  ...
  },
  {
    ...
    ZANNOTATIONREPRESENTATIVETEXT:
      'This is a contextual text for the second aggregated highlight from the Apple iPhone User Guide\n\ncontaining a new line to test the preservation of indentation',
    ...
    ZANNOTATIONNOTE:
      'Test note for the second aggregated highlight from the Apple iPhone User Guide\n\nalong with a new line to test the preservation of indentation',
